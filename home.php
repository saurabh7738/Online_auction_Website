                        ...
                        <ul class='list-group' id='cat-list'>
                            ...
                            while ($row = $cat->fetch_assoc()):
                                ...
                                <li class='list-group-item' data-id='<?php echo $row['id'] ?>'
                                    data-href="index.php?page=home&category_id=<?php echo $row['id'] ?>"><?php echo ucwords($row['name']) ?></li>
                                ...
                                <div class="col-sm-4">
                                    <div class="card">
                                        <div class="float-right align-top bid-tag">
                                            <span class="badge badge-pill badge-primary text-white"><i
                                                    class="fa fa-tag"></i>
                                        ...
                                        <div class="card-body prod-item">
                                            ...
                                            <button class="btn btn-primary btn-sm view_prod" type="button"
